...
- Optional MiniFASNetV2 passive liveness check (print-attack detection only).
...
See [Open Risks](./README.md#open-risks). Notably: liveness does not detect
screen/video replay, and the default thresholds are uncalibrated placeholders.
